...
exports.ROLE_GOAL_MULTIPLIER = exports.POSITION_ASSIST_WEIGHT = exports.POSITION_GOAL_WEIGHT = exports.FORMATION_IDS = exports.FORMATIONS = void 0;
const GK = { id: 'GK', role: 'GK', natural: ['GK'], x: 50, y: 4 };
exports.FORMATIONS = {
    '4-3-3': {
        id: '4-3-3',
        name: '4-3-3',
...
exports.FORMATION_IDS = Object.keys(exports.FORMATIONS);
/** Position-group weighting for goal involvement, used by scorer selection and ratings. */
exports.POSITION_GOAL_WEIGHT = {
    GK: 0.001,
    DF: 0.06,
    MF: 0.25,
    FW: 0.69,
};
exports.POSITION_ASSIST_WEIGHT = {
    GK: 0.005,
    DF: 0.14,
    MF: 0.48,
    FW: 0.375,
